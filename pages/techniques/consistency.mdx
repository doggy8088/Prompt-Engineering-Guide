...
或許在提示工程中，更高級的技術之一是自洽性。由 [Wang et al. (2022)](https://arxiv.org/pdf/2203.11171.pdf) 提出，自洽性的目標是「取代鏈式思考提示中使用的天真貪婪解碼」。其想法是透過少量樣本的多樣化推理路徑進行抽樣，並使用產生的結果選擇最一致的答案。這有助於提高鏈式思考提示在涉及算術和常識推理的任務中的效能。
