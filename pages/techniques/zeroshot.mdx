...
今天的LLMs在大量的資料訓練和調整後，能夠執行零-shot任務。我們在前一節中嘗試了一些零-shot示範。這是我們使用的其中一個示範：
...
請注意，上面的提示中我們沒有向模型提供任何示範——這就是零-shot能力在發揮作用。
...
當零-shot 無法運作時，建議在提示中提供示範或範例，以進行少量-shot 提示。在下一節中，我們將展示少量-shot 提示。
